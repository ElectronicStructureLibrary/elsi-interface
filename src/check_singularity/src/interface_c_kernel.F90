 ...
 interface
  ...
  contains
    ...
    subroutine launch_dot_product_kernel_double(hs_dev, hv_new_dev, tau_new, x_dev, h_dev,hv_dev, nr)
      ...
      call launch_dot_product_kernel_c_double(hs_dev, hv_new_dev, tau_new, x_dev, h_dev,hv_dev, nr)
#endif
    end subroutine
...
#ifdef WITH_GPU_VERSION
      call launch_dot_product_kernel_2_c_double(ab_dev, hs_dev, hv_dev,hd_dev,nb, nr, ne)
#endif
    end subroutine
...
#ifdef WITH_GPU_VERSION
      call launch_double_hh_transform_2_c_double(ab_dev, hd_dev,hv_dev,nc,ns, nb)
#endif
    end subroutine
...
#ifdef WITH_GPU_VERSION
      call launch_compute_kernel_reduce_c_double(a_dev, lda, n, nbw, h1_dev)
#endif
    end subroutine
...
#ifdef WITH_GPU_VERSION
      call launch_my_unpack_c_kernel_real_c_double(row_count, n_offset, max_idx,stripe_width, a_dim2, stripe_count, &
                                            l_nev,row_group_dev, a_dev)
#endif
...
#ifdef WITH_GPU_VERSION
      call launch_my_pack_c_kernel_real_c_double(row_count, n_offset, max_idx,stripe_width, a_dim2, stripe_count, l_nev, a_dev, &
                                       row_group_dev)
#endif
    ...
    subroutine launch_my_unpack_c_kernel_complex_double(row_count, n_offset, max_idx, stripe_width, a_dim2, stripe_count, l_nev, &
      ...
      integer(kind=c_intptr_t)  :: a_dev, row_group_dev
#ifdef WITH_GPU_VERSION
      call launch_my_unpack_c_kernel_complex_c_double(row_count, n_offset, max_idx, stripe_width, a_dim2, stripe_count, l_nev, &
                                                 row_group_dev, a_dev)
#endif
    end subroutine
    ...
    subroutine launch_my_pack_c_kernel_complex_double(row_count, n_offset, max_idx,stripe_width,a_dim2, &
      ...
      integer(kind=c_intptr_t) :: row_group_dev
#ifdef WITH_GPU_VERSION
      call launch_my_pack_c_kernel_complex_c_double(row_count, n_offset, max_idx,stripe_width,a_dim2, stripe_count, l_nev, a_dev, &
                                               row_group_dev)
#endif
    end subroutine
    ...
    subroutine launch_extract_hh_tau_c_kernel_complex_double(hh, hh_tau, nb, n, is_zero)
      ...
      integer(kind=c_int)    :: is_zero
#ifdef WITH_GPU_VERSION
      call launch_extract_hh_tau_c_kernel_complex_c_double(hh, hh_tau, nb, n, is_zero)
#endif
    end subroutine
