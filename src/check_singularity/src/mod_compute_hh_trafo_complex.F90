...
module compute_hh_trafo_complex_cs
  use elpa_mpi_cs
  implicit none
  ...
  contains
         ...
         subroutine compute_hh_trafo_complex_cpu_double       (a, stripe_width, a_dim2, stripe_count,                             &
           ...
           use complex_generic_simple_kernel_cs !, only : single_hh_trafo_complex_generic_simple
#endif
#if defined(WITH_COMPLEX_GENERIC_KERNEL)
           use complex_generic_kernel_cs !, only : single_hh_trafo_complex_generic
#endif
