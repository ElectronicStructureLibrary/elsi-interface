...
subroutine elsi_reinit(eh)
   ...
   if(eh%ph%n_calls > 0) then
      ...
      eh%ph%first_blacs_to_ntpoly = .false.
      eh%ph%first_blacs_to_pexsi = .false.
      eh%ph%first_blacs_to_sips = .false.
      eh%ph%first_siesta_to_blacs = .false.
      eh%ph%first_siesta_to_pexsi = .false.
      eh%ph%first_sips_to_blacs = .false.
      eh%ph%first_sips_to_ntpoly = .false.
