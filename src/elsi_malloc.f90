...
module ELSI_MALLOC
   ...
   interface elsi_allocate
      ...
      module procedure elsi_allocate_integer8_2d
      ...
      module procedure elsi_allocate_integer4_1d_dimint8
      module procedure elsi_allocate_integer8_1d_dimint8
      module procedure elsi_allocate_real8_1d_dimint8
      module procedure elsi_allocate_complex16_1d_dimint8
   end interface
   ...
   interface elsi_deallocate
      ...
      module procedure elsi_deallocate_integer8_2d
...
!!
subroutine elsi_allocate_integer8_2d(bh,array,dim_1,dim_2,label,caller)
...
!! Allocate a 1D array with integer(kind=i4).
!!
subroutine elsi_allocate_integer4_1d_dimint8(bh,array,dim_1,label,caller)

   implicit none

   type(elsi_basic_t), intent(in) :: bh
   integer(kind=i4), intent(inout), allocatable :: array(:)
   integer(kind=i8), intent(in) :: dim_1
   character(len=*), intent(in) :: label
   character(len=*), intent(in) :: caller
...
!! Allocate a 1D array with integer(kind=i8).
!!
subroutine elsi_allocate_integer8_1d_dimint8(bh,array,dim_1,label,caller)
...
!! Allocate a 1D array with real(kind=r8).
!!
subroutine elsi_allocate_real8_1d_dimint8(bh,array,dim_1,label,caller)
...
!! Allocate a 1D array with complex(kind=r8).
!!
subroutine elsi_allocate_complex16_1d_dimint8(bh,array,dim_1,label,caller)
...
!! Deallocate a 1D array with integer(kind=i8).
!!
subroutine elsi_deallocate_integer8_2d(bh,array,label)
