...
!!
subroutine elsi_allocate_real4_1d(bh,array,dim_1,arrayname,caller)
...
!!
subroutine elsi_allocate_real8_1d(bh,array,dim_1,arrayname,caller)
...
!!
subroutine elsi_allocate_integer4_1d(bh,array,dim_1,arrayname,caller)
...
!!
subroutine elsi_allocate_integer8_1d(bh,array,dim_1,arrayname,caller)
...
!!
subroutine elsi_allocate_complex16_1d(bh,array,dim_1,arrayname,caller)
...
!!
subroutine elsi_allocate_real4_2d(bh,array,dim_1,dim_2,arrayname,caller)
   ...
   if(bh%print_info > 2) then
      arraysize = 1.0e-6_r8*dim_1*dim_2*4
...
!!
subroutine elsi_allocate_real8_2d(bh,array,dim_1,dim_2,arrayname,caller)
   ...
   if(bh%print_info > 2) then
      arraysize = 1.0e-6_r8*dim_1*dim_2*8
...
!!
subroutine elsi_allocate_integer4_2d(bh,array,dim_1,dim_2,arrayname,caller)
...
!!
subroutine elsi_allocate_complex8_2d(bh,array,dim_1,dim_2,arrayname,caller)
...
!!
subroutine elsi_allocate_complex16_2d(bh,array,dim_1,dim_2,arrayname,caller)
   ...
   if(bh%print_info > 2) then
      arraysize = 1.0e-6_r8*dim_1*dim_2*16
...
!!
subroutine elsi_allocate_real8_3d(bh,array,dim_1,dim_2,dim_3,arrayname,caller)
   ...
   if(bh%print_info > 2) then
      arraysize = 1.0e-6_r8*dim_1*dim_2*dim_3*8
...
!!
subroutine elsi_allocate_integer4_3d(bh,array,dim_1,dim_2,dim_3,arrayname,&
              caller)
   ...
   if(bh%print_info > 2) then
      arraysize = 1.0e-6_r8*dim_1*dim_2*dim_3*4
...
!!
subroutine elsi_allocate_complex16_3d(bh,array,dim_1,dim_2,dim_3,arrayname,&
              caller)
   ...
   if(bh%print_info > 2) then
      arraysize = 1.0e-6_r8*dim_1*dim_2*dim_3*16
...
!!
subroutine elsi_deallocate_real4_1d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_real8_1d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_integer4_1d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_integer8_1d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_complex16_1d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_real4_2d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_real8_2d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_integer4_2d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_complex8_2d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_complex16_2d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_real8_3d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_integer4_3d(bh,array,arrayname)
...
!!
subroutine elsi_deallocate_complex16_3d(bh,array,arrayname)
