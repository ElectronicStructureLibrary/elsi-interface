!==================================================================================================!
! example6 : k points, spin unpolarized                                                            !
!                                                                                                  !
! This example is the same as example3, but demonstrates the use of the wrappers.                  !
!                                                                                                  !
  ...
  do imd=1,2
    ...
    do i=1,nk
      ...
      call omm_szden_ref(m,n,H(1,1,i),.true.,S(1,1,i),.false.,e_min(i),ED_min(1,1,i),.true.,eta,C_min(1,1,i),.false.,.false.,T,&
               0.0_dp,1,nk,i,-1.0_dp,.true.,dealloc,mpi_rank)
#endif
