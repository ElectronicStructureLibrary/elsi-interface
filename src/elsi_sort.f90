...
module ELSI_SORT
   ...
   interface swap
      ...
      module procedure swap_i8_dimint8
      module procedure swap_i4_dimint8
      module procedure swap_r8_dimint8
   end interface
   ...
   interface downheap
      ...
      module procedure downheap_i4_dimint8
      module procedure downheap_i8_dimint8
      module procedure downheap_r8_dimint8
   end interface
   ...
   interface elsi_heapsort
      ...
      module procedure heapsort_i4_dimint8
      module procedure heapsort_i8_dimint8
      module procedure heapsort_r8_dimint8
   end interface
   ...
   interface elsi_permute
      ...
      module procedure permute_i4_dimint8
      module procedure permute_r8_dimint8
      module procedure permute_c16_dimint8
   end interface

   interface elsi_unpermute
      module procedure unpermute_r8
      module procedure unpermute_c16
      module procedure unpermute_r8_dimint8
      module procedure unpermute_c16_dimint8
   end interface
...
!! Sort a real(kind=r8) array by heapsort, returns an array of permutation.
!!
subroutine heapsort_r8_dimint8(length,array,perm)

   implicit none

   integer(kind=i8), intent(in) :: length
   real(kind=r8), intent(inout) :: array(length)
   integer(kind=i8), intent(out) :: perm(length)
   ...
   do while(i > 1)
      call swap(length,array,int(1,kind=i8),i)
      call swap(length,perm,int(1,kind=i8),i)

      i = i-1

      call downheap(length,array,perm,int(1,kind=i8),i)
   end do
...
!! Restore the max-heap structure.
!!
subroutine downheap_r8_dimint8(length,a_r8,b_i4,top,bottom)

   implicit none

   integer(kind=i8), intent(in) :: length
   real(kind=r8), intent(inout) :: a_r8(length)
   integer(kind=i8), intent(inout) :: b_i4(length)
   integer(kind=i8), intent(in) :: top
   integer(kind=i8), intent(in) :: bottom
...
!! Sort an integer(kind=i8) array by heapsort, returns an array of permutation.
!!
subroutine heapsort_i8_dimint8(length,array,perm)
...
!! Restore the max-heap structure.
!!
subroutine downheap_i8_dimint8(length,a_i8,b_i4,top,bottom)
...
!! Sort an integer(kind=i4) array by heapsort, returns an array of permutation.
!!
subroutine heapsort_i4_dimint8(length,array,perm)
...
!! Restore the max-heap structure.
!!
subroutine downheap_i4_dimint8(length,a_i4,b_i4,top,bottom)
...
!! Permute an integer(kind=i4) array.
!!
subroutine permute_i4_dimint8(length,perm,array)

   implicit none

   integer(kind=i8), intent(in) :: length
   integer(kind=i8), intent(in) :: perm(length)
   integer(kind=i4), intent(inout) :: array(length)
...
!! Permute a real(kind=r8) array.
!!
subroutine permute_r8_dimint8(length,perm,array)
...
!! Permute a complex(kind=r8) array.
!!
subroutine permute_c16_dimint8(length,perm,array)
...
!! Unpermute a real(kind=r8) array.
!!
subroutine unpermute_r8_dimint8(length,perm,array)
...
!! Unpermute a complex(kind=r8) array.
!!
subroutine unpermute_c16_dimint8(length,perm,array)
...
!! Swap two numbers in an integer(kind=i8) array.
!!
subroutine swap_i8_dimint8(length,array,i,j)
...
!! Swap two numbers in an integer(kind=i4) array.
!!
subroutine swap_i4_dimint8(length,array,i,j)
...
!! Swap two numbers in a real(kind=r8) array.
!!
subroutine swap_r8_dimint8(length,array,i,j)
