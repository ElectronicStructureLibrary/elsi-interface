      SUBROUTINE PSSSMV( UPLO, N, ALPHA, A, IA, JA, DESCA, X, IX, JX,
...
*  =======
*
*  PSSSMV performs the matrix-vector operation
*
...
*     .. External Subroutines ..
      EXTERNAL           DESCSET, PSAXPY, PSCOPY, PSSCAL, PSTRMV
*     ..
...
*
      CALL PSSCAL( N, BETA, Y, IY, JY, DESCY, INCY )
*
      IF ( ALPHA .NE. ZERO ) THEN
         CALL PSCOPY( N, X, IX, JX, DESCX, INCX, WORK, 1, 1, DESCWK, 1 )
         CALL PSTRMV( UPLO, 'N', 'N', N, A, IA, JA, DESCA, WORK, 1, 1,
     $        DESCWK, 1 )
         CALL PSAXPY( N, ALPHA, WORK, 1, 1, DESCWK, 1, Y, IY, JY, DESCY,
     $        INCY )
         CALL PSCOPY( N, X, IX, JX, DESCX, INCX, WORK, 1, 1, DESCWK, 1 )
         CALL PSTRMV( UPLO, 'T', 'N', N, A, IA, JA, DESCA, WORK, 1, 1,
     $        DESCWK, 1 )
         CALL PSAXPY( N, -ALPHA, WORK, 1, 1, DESCWK, 1, Y, IY, JY,
     $        DESCY, INCY )
      END IF
*
      RETURN
