      SUBROUTINE PDSSR2K( UPLO, TRANS, N, K, ALPHA, A, IA, JA, DESCA, B,
...
*  =======
*
*  PDSSR2K performs one of the skew-symmetric rank 2k operations
*
...
*          not be set on input.
*
*  C       (local input) DOUBLE PRECISION array
...
*     .. External Subroutines ..
      EXTERNAL           DESCSET, PDGEMM, PDTRADD
*     ..
*     .. External Functions ..
      EXTERNAL           LSAME
      LOGICAL            LSAME
...
*
      IF ( LSAME( TRANS, 'N' ) ) THEN
         CALL PDGEMM( 'N', 'T', N, N, K, ALPHA, A, IA, JA, DESCA,
     $        B, IB, JB, DESCB, ZERO, WORK, 1, 1, DESCWK )
      ELSE
         CALL PDGEMM( 'T', 'N', N, N, K, ALPHA, A, IA, JA, DESCA,
     $        B, IB, JB, DESCB, ZERO, WORK, 1, 1, DESCWK )
      END IF
      CALL PDTRADD( UPLO, 'N', N, N, ONE, WORK, 1, 1, DESCWK, BETA,
     $     C, IC, JC, DESCC )
      IF ( ALPHA .NE. ZERO ) THEN
         CALL PDTRADD( UPLO, 'T', N, N, -ONE, WORK, 1, 1, DESCWK, ONE,
     $        C, IC, JC, DESCC )
      END IF
      RETURN
*
