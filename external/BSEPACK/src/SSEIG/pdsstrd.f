      SUBROUTINE PDSSTRD( UPLO, N, A, IA, JA, DESCA, E, TAU, WORK,
     $                    LWORK, INFO )
*
      IMPLICIT NONE
*
...
*     .. Array Arguments ..
      INTEGER            DESCA( * )
      DOUBLE PRECISION   A( * ), E( * ), TAU( * ), WORK( * )
*     ..
*
*  Purpose
*  =======
*
*  PDSSTRD reduces a real skew-symmetric matrix sub( A ) to
...
*
*  PDSSTRD is modified from PDSYTRD in ScaLAPACK version 2.0.2.
*
...
*     .. External Subroutines ..
     ...
     $                   PDLASTD, PDSSR2K, PDSSTD2, PB_TOPGET,
     $                   PB_TOPSET, PXERBLA, PDELSET
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
...
*
      IF ( INFO .NE. 0 ) THEN
         CALL PXERBLA( ICTXT, 'PDSSTRD', -INFO )
         RETURN
      ELSE IF ( LQUERY ) THEN
         RETURN
      END IF
...
*           the matrix.
*
            CALL PDLASTD( UPLO, K+JB-1, JB, A, IA, JA, DESCA, E, TAU,
...
*
            CALL PDSSR2K( UPLO, 'N', K-1, JB, ONE, A, IA, J, DESCA,
...
*
         CALL PDSSTD2( UPLO, MIN( N, NB ), A, IA, JA, DESCA, E, TAU,
     $        WORK, LWORK, IINFO )
*
      ELSE
*
...
*           of the matrix.
*
            CALL PDLASTD( UPLO, N-K+1, NB, A, I, J, DESCA, E, TAU,
...
*
            CALL PDSSR2K( UPLO, 'N', N-K-NB+1, NB, ONE, A, I+NB, J,
...
*        Use unblocked code to reduce the last or only block.
*
         CALL PDSSTD2( UPLO, KK, A, IA+K-1, JA+K-1, DESCA, E, TAU,
     $        WORK, LWORK, IINFO )
      END IF
*
