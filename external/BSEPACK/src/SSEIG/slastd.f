      SUBROUTINE SLASTD( UPLO, N, NB, A, LDA, E, TAU, W, LDW )
*
*     .. Scalar Arguments ..
      CHARACTER          UPLO
...
*  =======
*
*  SLASTD reduces NB rows and columns of a real skew-symmetric matrix A
...
*
*  If UPLO = 'U', SLASTD reduces the last NB rows and columns of a
*  matrix, of which the upper triangle is supplied;
*  if UPLO = 'L', SLASTD reduces the first NB rows and columns of a
*  matrix, of which the lower triangle is supplied.
*
*  This is an auxiliary routine called by SSSTRD.
*
*  Arguments
*  =========
*
...
*
*  SLASTD is modified from SLATRD in LAPACK version 3.5.0.
*
...
*     .. External Subroutines ..
      EXTERNAL           SGEMV, SLARFG, SSCAL, SSSMV
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*
               IF ( I .LT. N ) THEN
                  CALL SGEMV( 'N', I-1, N-I, ONE, A( 1, I+1 ), LDA,
     $                 W( I, IW+1 ), LDW, ONE, A( 1, I ), 1 )
                  CALL SGEMV( 'N', I-1, N-I, -ONE, W( 1, IW+1 ), LDW,
...
*              Compute W(1:i-1,i).
*
               CALL SSSMV( 'U', I-1, ONE, A, LDA, A( 1, I ), 1, ZERO,
     $              W( 1, IW ), 1 )
               IF ( I .LT. N ) THEN
                  CALL SGEMV( 'T', I-1, N-I, ONE, W( 1, IW+1 ), LDW,
     $                 A( 1, I ), 1, ZERO, W( I+1, IW ), 1 )
                  CALL SGEMV( 'N', I-1, N-I, ONE, A( 1, I+1 ), LDA,
     $                 W( I+1, IW ), 1, ONE, W( 1, IW ), 1 )
                  CALL SGEMV( 'T', I-1, N-I, ONE, A( 1, I+1 ), LDA,
     $                 A( 1, I ), 1, ZERO, W( I+1, IW ), 1 )
                  CALL SGEMV( 'N', I-1, N-I, -ONE, W( 1, IW+1 ), LDW,
     $                 W( I+1, IW ), 1, ONE, W( 1, IW ), 1 )
               END IF
...
*
               IF ( I .GT. 1 ) THEN
                  CALL SGEMV( 'N', N-I, I-1, ONE, A( I+1, 1 ), LDA,
     $                 W( I, 1 ), LDW, ONE, A( I+1, I ), 1 )
                  CALL SGEMV( 'N', N-I, I-1, -ONE, W( I+1, 1 ), LDW,
...
*              Compute W(i+1:n,i).
*
               CALL SSSMV( 'L', N-I, ONE, A( I+1, I+1 ), LDA,
     $              A( I+1, I ), 1, ZERO, W( I+1, I ), 1 )
               CALL SGEMV( 'T', N-I, I-1, ONE, W( I+1, 1 ), LDW,
     $              A( I+1, I ), 1, ZERO, W( 1, I ), 1 )
               CALL SGEMV( 'N', N-I, I-1, ONE, A( I+1, 1 ), LDA,
     $              W( 1, I ), 1, ONE, W( I+1, I ), 1 )
               CALL SGEMV( 'T', N-I, I-1, ONE, A( I+1, 1 ), LDA,
     $              A( I+1, I ), 1, ZERO, W( 1, I ), 1 )
               CALL SGEMV( 'N', N-I, I-1, -ONE, W( I+1, 1 ), LDW,
     $              W( 1, I ), 1, ONE, W( I+1, I ), 1 )
