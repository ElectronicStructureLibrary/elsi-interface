      SUBROUTINE SSSTRD( UPLO, N, A, LDA, E, TAU, WORK, LWORK, INFO )
*
      IMPLICIT NONE
*
*     .. Scalar Arguments ..
...
*     ..
*     .. Array Arguments ..
      REAL               A( LDA, * ), E( * ), TAU( * ), WORK( * )
*     ..
*
*  Purpose
*  =======
*
*  SSSTRD reduces a real skew-symmetric matrix A to skew-symmetric
...
*
*  SSSTRD is modified from SSYTRD in LAPACK version 3.5.0.
*
...
*     .. External Subroutines ..
      EXTERNAL           SLASTD, SSSR2K, SSSTD2, XERBLA
*     ..
*     .. External Functions ..
      INTEGER            ILAENV
      LOGICAL            LSAME
...
*           the matrix.
*
            CALL SLASTD( UPLO, I+NB-1, NB, A, LDA, E, TAU, WORK,
     $           LDWORK )
*
*           Update the unreduced submatrix A(1:i-1,1:i-1), using an
*           update of the form:  A := A + V*W**T - W*V**T.
*
            CALL SSSR2K( UPLO, 'N', I-1, NB, ONE, A( 1, I ), LDA, WORK,
     $           LDWORK, ONE, A, LDA )
*
...
*
         CALL SSSTD2( UPLO, KK, A, LDA, E, TAU, IINFO )
      ELSE
*
...
*           the matrix.
*
            CALL SLASTD( UPLO, N-I+1, NB, A( I, I ), LDA, E( I ),
     $                   TAU( I ), WORK, LDWORK )
*
*           Update the unreduced submatrix A(i+ib:n,i+ib:n), using
*           an update of the form:  A := A + V*W**T - W*V**T.
*
            CALL SSSR2K( UPLO, 'N', N-I-NB+1, NB, ONE, A( I+NB, I ),
...
*        Use unblocked code to reduce the last or only block.
*
         CALL SSSTD2( UPLO, N-I+1, A( I, I ), LDA, E( I ), TAU( I ),
     $        IINFO )
      END IF
*
      WORK( 1 ) = REAL( LWKOPT )
