      SUBROUTINE SSSTD2( UPLO, N, A, LDA, E, TAU, INFO )
*
      IMPLICIT NONE
*
*     .. Scalar Arguments ..
...
*  =======
*
*  SSSTD2 reduces a real skew-symmetric matrix A to skew-symmetric
...
*
*  SSSTD2 is modified from SSYTD2 in LAPACK version 3.5.0.
*
...
*     .. External Subroutines ..
      EXTERNAL           SLARFG, SSSMV, SSSR2, XERBLA
*     ..
*     .. External Functions ..
      LOGICAL            LSAME
      EXTERNAL           LSAME
...
*
               CALL SSSMV( UPLO, I, TAUI, A, LDA, A( 1, I+1 ), 1, ZERO,
     $              TAU, 1 )
*
*              Apply the transformation as a rank-2 update:
*                 A := A + v * x**T - x * v**T.
*
               CALL SSSR2( UPLO, I, ONE, A( 1, I+1 ), 1, TAU, 1, A,
     $              LDA )
*
               A( I, I+1 ) = E( I )
            END IF
...
*
               CALL SSSMV( UPLO, N-I, TAUI, A( I+1, I+1 ), LDA,
     $              A( I+1, I ), 1, ZERO, TAU( I ), 1 )
*
*              Apply the transformation as a rank-2 update:
*                 A := A + v * x**T - x * v**T.
*
               CALL SSSR2( UPLO, N-I, ONE, A( I+1, I ), 1, TAU( I ), 1,
     $              A( I+1, I+1 ), LDA )
*
               A( I+1, I ) = -E( I )
            END IF
