!==================================================================================================!
! example11 : Gamma-point only, spin polarized                                                     !
!                                                                                                  !
! This example is the same as example8, but demonstrates the use of the wrappers and sparse        !
...
program example11
  ...
  type(matrix) :: H_upsp, H_downsp, Ssp
  ...
  deallocate(H_down)
  deallocate(H_up)
  call m_deallocate(H_upsp)
  call m_deallocate(H_downsp)
