...
5 format (a,i4,a,f16.10,a,f16.10)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call pzgemm('n','n',m,n,k,cmplx_1,H,1,1,desc_H,S,1,1,desc_S,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,H,'n',S,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Hsp,'n',S,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,H,'n',Ssp,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0=MPI_Wtime()
  do i=1,niter
     call pzgemm('n','c',m,n,k,cmplx_1,H,1,1,desc_H,St,1,1,desc_St,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,H,'n',St,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Hsp,'n',St,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,H,'n',Stsp,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call pzgemm('c','n',m,n,k,cmplx_1,Ht,1,1,desc_Ht,S,1,1,desc_S,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,Ht,'c',S,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Htsp,'c',S,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,Ht,'c',Ssp,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call pzgemm('c','c',m,n,k,cmplx_1,Ht,1,1,desc_Ht,St,1,1,desc_St,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,Ht,'c',St,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Htsp,'c',St,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,Ht,'c',Stsp,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0=MPI_Wtime()
  do i=1,niter
     call pzgemm('n','t',m,n,k,cmplx_1,H,1,1,desc_H,St,1,1,desc_St,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,H,'n',St,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Hsp,'n',St,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,H,'n',Stsp,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call pzgemm('t','n',m,n,k,cmplx_1,Ht,1,1,desc_Ht,S,1,1,desc_S,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,Ht,'t',S,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Htsp,'t',S,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,Ht,'t',Ssp,'n',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call pzgemm('t','t',m,n,k,cmplx_1,Ht,1,1,desc_Ht,St,1,1,desc_St,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,Ht,'t',St,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Htsp,'t',St,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,Ht,'t',Stsp,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0=MPI_Wtime()
  do i=1,niter
     call pzgemm('c','t',m,n,k,cmplx_1,Ht,1,1,desc_Ht,St,1,1,desc_St,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,Ht,'c',St,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Htsp,'c',St,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,Ht,'c',Stsp,'t',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call pzgemm('t','c',m,n,k,cmplx_1,Ht,1,1,desc_Ht,St,1,1,desc_St,cmplx_1,D,1,1,desc_D)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemm(m,n,k,Ht,'t',St,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gespmm(m,n,k,Htsp,'t',St,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
  ...
  t0 = MPI_Wtime()
  do i=1,niter
     call psp_gemspm(m,n,k,Ht,'t',Stsp,'c',DD,cmplx_1,cmplx_1)
  enddo
  t1 = MPI_Wtime()
  dtime=(t1-t0)/DBLE(niter)
  mm_err=MAXVAL(abs(D-DD))
