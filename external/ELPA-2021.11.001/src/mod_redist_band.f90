...
(obj, a_mat, lda, na, nblk, nbw, matrixCols, mpi_comm_rows, mpi_comm_cols, mpi_comm_all, ab)
  ...
  call check_allocate_f("redist_band: global_id", 134,  istat,  errorMessage)
  global_id(:,:) = 0
  ...
  call check_allocate_f("redist_band: block_limits", 179,  istat,  errorMessage)
  call divide_band(obj, nblocks_total, n_pes, block_limits)


  allocate(ncnt_s(0:n_pes-1), stat=istat, errmsg=errorMessage)
  call check_allocate_f("redist_band: ncnt_s", 184,  istat,  errorMessage)
  allocate(nstart_s(0:n_pes-1), stat=istat, errmsg=errorMessage)
  call check_allocate_f("redist_band: nstart_s", 186,  istat,  errorMessage)
  allocate(ncnt_r(0:n_pes-1), stat=istat, errmsg=errorMessage)
  call check_allocate_f("redist_band: ncnt_r", 188,  istat,  errorMessage)
  allocate(nstart_r(0:n_pes-1), stat=istat, errmsg=errorMessage)
  call check_allocate_f("redist_band: nstart_r", 190,  istat,  errorMessage)
  ...
  call check_allocate_f("redist_band: sbuf", 213,  istat,  errorMessage)
  sbuf(:,:,:) = 0.
  ...
  call check_allocate_f("redist_band: rbuf", 261,  istat,  errorMessage)
  ...
  call check_allocate_f("redist_band: buf", 303,  istat,  errorMessage)
  ...
  call check_deallocate_f("redist_band: ncnt_s, nstart_s", 327,  istat,  errorMessage)
  deallocate(ncnt_r, nstart_r, stat=istat, errmsg=errorMessage)
  call check_deallocate_f("redist_band: ncnt_r, nstart_r", 329,  istat,  errorMessage)
  deallocate(global_id, stat=istat, errmsg=errorMessage)
  call check_deallocate_f("redist_band: global_id", 331,  istat,  errorMessage)
  deallocate(block_limits, stat=istat, errmsg=errorMessage)
  call check_deallocate_f("redist_band: block_limits", 333,  istat,  errorMessage)

  deallocate(sbuf, rbuf, buf, stat=istat, errmsg=errorMessage)
  call check_deallocate_f("redist_band: sbuf, rbuf, buf", 336,  istat,  errorMessage)
