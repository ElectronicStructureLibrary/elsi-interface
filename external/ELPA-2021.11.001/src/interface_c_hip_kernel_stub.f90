...
module hip_c_kernel
  ...
  interface
    subroutine launch_compute_hh_trafo_c_hip_kernel_real_double(q, hh, hh_tau, nev, nb, ldq, ncols) &
               bind(c)
  ...
  interface
    subroutine launch_compute_hh_trafo_c_hip_kernel_real_single(q, hh, hh_tau, nev, nb, ldq, ncols) &
               bind(c)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int), value :: nev, nb, ldq, ncols
  ...
  interface
    subroutine launch_compute_hh_trafo_c_hip_kernel_complex_double(q, hh, hh_tau, nev, nb, ldq, ncols) &
               bind(c)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int), value :: nev, nb, ldq, ncols
  ...
  interface
    subroutine launch_compute_hh_trafo_c_hip_kernel_complex_single(q, hh, hh_tau, nev, nb, ldq, ncols) &
               bind(c)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int), value :: nev, nb, ldq, ncols
  ...
  interface
    subroutine launch_extract_hh_tau_c_hip_kernel_real_double(hh, hh_tau, nb, n, is_zero) &
               bind(c)
      use, intrinsic :: iso_c_binding
      implicit none
  ...
  interface
    subroutine launch_extract_hh_tau_c_hip_kernel_real_single(hh, hh_tau, nb, n, is_zero) &
               bind(c)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value :: hh
 ...
 interface
  ...
  interface
    subroutine launch_extract_hh_tau_c_hip_kernel_complex_double(hh, hh_tau, nb, n, is_zero) &
               bind(c)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value :: hh
  ...
  interface
    subroutine launch_extract_hh_tau_c_hip_kernel_complex_single(hh, hh_tau, nb, n, is_zero) &
               bind(c)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value :: hh
  ...
  contains
    ...
    subroutine launch_compute_hh_trafo_hip_kernel_real_double(q, hh, hh_tau, nev, nb, ldq, ncols)
      use, intrinsic :: iso_c_binding
      implicit none
    ...
    subroutine launch_compute_hh_trafo_hip_kernel_real_single(q, hh, hh_tau, nev, nb, ldq, ncols)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: nev, nb, ldq, ncols
      integer(kind=c_intptr_t) :: q
    ...
    subroutine launch_compute_hh_trafo_hip_kernel_complex_double(q, hh, hh_tau, nev, nb, ldq, ncols)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: nev, nb, ldq, ncols
      integer(kind=c_intptr_t) :: q
    ...
    subroutine launch_compute_hh_trafo_hip_kernel_complex_single(q, hh, hh_tau, nev, nb, ldq, ncols)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_int) :: nev, nb, ldq, ncols
      integer(kind=c_intptr_t) :: q
    ...
    subroutine launch_extract_hh_tau_hip_kernel_real_double(hh, hh_tau, nb, n, is_zero)
      use, intrinsic :: iso_c_binding
      implicit none
    ...
    subroutine launch_extract_hh_tau_hip_kernel_real_single(hh, hh_tau, nb, n, is_zero)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t) :: hh
      integer(kind=c_intptr_t) :: hh_tau
    ...
    subroutine launch_extract_hh_tau_hip_kernel_complex_double(hh, hh_tau, nb, n, is_zero)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t) :: hh
      integer(kind=c_intptr_t) :: hh_tau
    ...
    subroutine launch_extract_hh_tau_hip_kernel_complex_single(hh, hh_tau, nb, n, is_zero)
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t) :: hh
      integer(kind=c_intptr_t) :: hh_tau
