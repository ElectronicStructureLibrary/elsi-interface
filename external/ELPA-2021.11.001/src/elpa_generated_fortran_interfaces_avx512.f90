...
module elpa_generated_fortran_interfaces
 ...
 interface
   function elpa_index_get_int_value_c(index, name, success) result(value) &
     ...
     integer(kind=c_int), optional, intent(out) :: success
 ...
 interface
   function elpa_index_get_float_value_c(index, name, success) result(value) bind(C, name="elpa_index_get_float_value")
     ...
     type(c_ptr), value                              :: index
     character(kind=c_char), intent(in)              :: name(*)
     integer(kind=c_int), intent(out), optional      :: success
 ...
 interface
   function elpa_index_autotune_cardinality_new_stepping_c(index, &
            autotune_level, &
       autotune_domain, autotune_part) result(n) &
       bind(C, name="elpa_index_autotune_cardinality_new_stepping")
     import c_int, c_ptr, c_char
     type(c_ptr), intent(in), value :: index
     integer(kind=c_int), intent(in), value :: autotune_level, &
                                               autotune_domain
     integer(kind=c_int), intent(in), value :: autotune_part
     integer(kind=c_int) :: n
   end function
 end interface
 ...
 interface
   function elpa_index_set_autotune_parameters_new_stepping_c(index, &
            autotune_level, autotune_domain, autotune_part, n) &
       result(success) &
       bind(C, name="elpa_index_set_autotune_parameters_new_stepping")
     import c_int, c_ptr, c_char
     type(c_ptr), intent(in), value :: index
     integer(kind=c_int), intent(in), value :: autotune_level, &
                                               autotune_domain, n
 ...
 interface
   function elpa_index_print_autotune_parameters_new_stepping_c(index, &
       autotune_level, autotune_domain, autotune_part) result(success) &
       bind(C, name="elpa_index_print_autotune_parameters_new_stepping")
     import c_int, c_ptr, c_char
     type(c_ptr), intent(in), value :: index
     integer(kind=c_int), intent(in), value :: autotune_level, &
                                               autotune_domain
 ...
 interface
   function elpa_index_print_autotune_state_new_stepping_c(index, &
            autotune_level, autotune_domain, autotune_part, min_loc, &
            min_val, current, cardinality, solver, file_name) result(success) &
       bind(C, name="elpa_index_print_autotune_state_new_stepping")
     import c_int, c_ptr, c_char, c_double
     type(c_ptr), intent(in), value :: index
     integer(kind=c_int), intent(in), value :: autotune_level, &
                                               autotune_domain, &
                                               min_loc, current, &
                                               cardinality
     integer(kind=c_int), intent(in), value :: autotune_part, solver
     real(kind=c_double), intent(in), value :: min_val
     character(kind=c_char), intent(in)     :: file_name(*)
     integer(kind=c_int) :: success
   end function
