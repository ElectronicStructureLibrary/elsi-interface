...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_12_AVX2_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq 
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_10_AVX2_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );
...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_8_AVX2_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_6_AVX2_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_4_AVX2_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_2_AVX2_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );
...
void single_hh_trafo_complex_AVX2_1hv_double (double _Complex* q, double _Complex* hh, int* pnb, int* pnq, int* pldq
		  )
{
     ...
     worked_on = 0;
        ...
        {
            hh_trafo_complex_kernel_12_AVX2_1hv_double (&q[i], hh, nb, ldq);
	    worked_on += 12;
        }
        ...
        if (nq-i == 10)
        {
            hh_trafo_complex_kernel_10_AVX2_1hv_double (&q[i], hh, nb, ldq);
	    worked_on += 10;
        }
        ...
        if (nq-i == 8)
        {
            hh_trafo_complex_kernel_8_AVX2_1hv_double (&q[i], hh, nb, ldq);
	    worked_on += 8;
        }
        ...
        if (nq-i == 6)
        {
            hh_trafo_complex_kernel_6_AVX2_1hv_double (&q[i], hh, nb, ldq);
	    worked_on += 6;
        }
        ...
        if (nq-i == 4)
        {
            hh_trafo_complex_kernel_4_AVX2_1hv_double (&q[i], hh, nb, ldq);
	    worked_on += 4;
        }
        ...
        if (nq-i == 2)
        {
            hh_trafo_complex_kernel_2_AVX2_1hv_double (&q[i], hh, nb, ldq);
	    worked_on += 2;
        }
