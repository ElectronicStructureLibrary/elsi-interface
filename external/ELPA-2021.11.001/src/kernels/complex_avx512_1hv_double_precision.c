...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_24_AVX512_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq 
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_20_AVX512_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );
...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_16_AVX512_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_12_AVX512_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_8_AVX512_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_4_AVX512_1hv_double(double _Complex* q, double _Complex* hh, int nb, int ldq
		                       );
...
void single_hh_trafo_complex_AVX512_1hv_double (double _Complex* q, double _Complex* hh, int* pnb, int* pnq, int* pldq
		  )
{
		...
		)
{
    ...
    x3 = _mm512_load_pd(&q_dbl[2*8]);
    x4 = _mm512_load_pd(&q_dbl[3*8]);
    x5 = _mm512_load_pd(&q_dbl[4*8]);
    x6 = _mm512_load_pd(&q_dbl[5*8]);
    ...
    for (i = 1; i < nb; i++)
    {
       ...
       h1_real = _mm512_set1_pd(hh_dbl[(i-1+1)*2]);
       h1_imag = _mm512_set1_pd(hh_dbl[((i-1+1)*2)+1]);


        q1 = _mm512_load_pd(&q_dbl[(2*i*ldq)+0]);
        q2 = _mm512_load_pd(&q_dbl[(2*i*ldq)+8]);
        q3 = _mm512_load_pd(&q_dbl[(2*i*ldq)+2*8]);
        q4 = _mm512_load_pd(&q_dbl[(2*i*ldq)+3*8]);
        q5 = _mm512_load_pd(&q_dbl[(2*i*ldq)+4*8]);
        q6 = _mm512_load_pd(&q_dbl[(2*i*ldq)+5*8]);

        tmp1 = _mm512_mul_pd(  h1_imag, q1);
        x1 = _mm512_add_pd(  x1, _mm512_fmsubadd_round_pd((h1_real), (q1), (_mm512_shuffle_pd(tmp1, tmp1, 0x55)), 0x04));

        tmp2 = _mm512_mul_pd(  h1_imag, q2);
        x2 = _mm512_add_pd(  x2, _mm512_fmsubadd_round_pd((h1_real), (q2), (_mm512_shuffle_pd(tmp2, tmp2, 0x55)), 0x04));

        tmp3 = _mm512_mul_pd(  h1_imag, q3);
        x3 = _mm512_add_pd(  x3, _mm512_fmsubadd_round_pd((h1_real), (q3), (_mm512_shuffle_pd(tmp3, tmp3, 0x55)), 0x04));

        tmp4 = _mm512_mul_pd(  h1_imag, q4);
        x4 = _mm512_add_pd(  x4, _mm512_fmsubadd_round_pd((h1_real), (q4), (_mm512_shuffle_pd(tmp4, tmp4, 0x55)), 0x04));

        tmp5 = _mm512_mul_pd(  h1_imag, q5);
        x5 = _mm512_add_pd(  x5, _mm512_fmsubadd_round_pd((h1_real), (q5), (_mm512_shuffle_pd(tmp5, tmp5, 0x55)), 0x04));

        tmp6 = _mm512_mul_pd(  h1_imag, q6);
        x6 = _mm512_add_pd(  x6, _mm512_fmsubadd_round_pd((h1_real), (q6), (_mm512_shuffle_pd(tmp6, tmp6, 0x55)), 0x04));
    ...
    x1 = _mm512_fmaddsub_round_pd((h1_real), (x1), (_mm512_shuffle_pd(tmp1, tmp1, 0x55)), 0x04);

    tmp2 = _mm512_mul_pd(  h1_imag, x2);
    x2 = _mm512_fmaddsub_round_pd((h1_real), (x2), (_mm512_shuffle_pd(tmp2, tmp2, 0x55)), 0x04);

    tmp3 = _mm512_mul_pd(  h1_imag, x3);
    x3 = _mm512_fmaddsub_round_pd((h1_real), (x3), (_mm512_shuffle_pd(tmp3, tmp3, 0x55)), 0x04);

    tmp4 = _mm512_mul_pd(  h1_imag, x4);
    x4 = _mm512_fmaddsub_round_pd((h1_real), (x4), (_mm512_shuffle_pd(tmp4, tmp4, 0x55)), 0x04);

    tmp5 = _mm512_mul_pd(  h1_imag, x5);
    x5 = _mm512_fmaddsub_round_pd((h1_real), (x5), (_mm512_shuffle_pd(tmp5, tmp5, 0x55)), 0x04);

    tmp6 = _mm512_mul_pd(  h1_imag, x6);
    x6 = _mm512_fmaddsub_round_pd((h1_real), (x6), (_mm512_shuffle_pd(tmp6, tmp6, 0x55)), 0x04);


    q1 = _mm512_load_pd(&q_dbl[0]);
    q2 = _mm512_load_pd(&q_dbl[8]);
    q3 = _mm512_load_pd(&q_dbl[2*8]);
    q4 = _mm512_load_pd(&q_dbl[3*8]);
    q5 = _mm512_load_pd(&q_dbl[4*8]);
    q6 = _mm512_load_pd(&q_dbl[5*8]);
    ...
    _mm512_store_pd(&q_dbl[2*8], q3);
    _mm512_store_pd(&q_dbl[3*8], q4);
    _mm512_store_pd(&q_dbl[4*8], q5);
    _mm512_store_pd(&q_dbl[5*8], q6);
    ...
    for (i = 1; i < nb; i++)
    {
        ...
        tmp1 = _mm512_mul_pd(  h1_imag, x1);
        q1 = _mm512_add_pd(  q1, _mm512_fmaddsub_round_pd((h1_real), (x1), (_mm512_shuffle_pd(tmp1, tmp1, 0x55)), 0x04));

        tmp2 = _mm512_mul_pd(  h1_imag, x2);
        q2 = _mm512_add_pd(  q2, _mm512_fmaddsub_round_pd((h1_real), (x2), (_mm512_shuffle_pd(tmp2, tmp2, 0x55)), 0x04));

        tmp3 = _mm512_mul_pd(  h1_imag, x3);
        q3 = _mm512_add_pd(  q3, _mm512_fmaddsub_round_pd((h1_real), (x3), (_mm512_shuffle_pd(tmp3, tmp3, 0x55)), 0x04));

         tmp4 = _mm512_mul_pd(  h1_imag, x4);
         q4 = _mm512_add_pd(  q4, _mm512_fmaddsub_round_pd((h1_real), (x4), (_mm512_shuffle_pd(tmp4, tmp4, 0x55)), 0x04));

         tmp5 = _mm512_mul_pd(  h1_imag, x5);
         q5 = _mm512_add_pd(  q5, _mm512_fmaddsub_round_pd((h1_real), (x5), (_mm512_shuffle_pd(tmp5, tmp5, 0x55)), 0x04));

         tmp6 = _mm512_mul_pd(  h1_imag, x6);
         q6 = _mm512_add_pd(  q6, _mm512_fmaddsub_round_pd((h1_real), (x6), (_mm512_shuffle_pd(tmp6, tmp6, 0x55)), 0x04));



         _mm512_store_pd(&q_dbl[(2*i*ldq)+0], q1);
         _mm512_store_pd(&q_dbl[(2*i*ldq)+8], q2);
         _mm512_store_pd(&q_dbl[(2*i*ldq)+2*8], q3);
         _mm512_store_pd(&q_dbl[(2*i*ldq)+3*8], q4);
         _mm512_store_pd(&q_dbl[(2*i*ldq)+4*8], q5);
         _mm512_store_pd(&q_dbl[(2*i*ldq)+5*8], q6);
    }
		...
		)
{
    ...
    __m512d x1, x2, x3, x4, x5;
    __m512d q1, q2, q3, q4, q5;
    __m512d h1_real, h1_imag;
    __m512d tmp1, tmp2, tmp3, tmp4, tmp5;
    int i=0;
