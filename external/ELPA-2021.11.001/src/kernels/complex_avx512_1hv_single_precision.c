...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_48_AVX512_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq 
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_40_AVX512_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );
...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_32_AVX512_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_24_AVX512_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_16_AVX512_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_8_AVX512_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );
...
void single_hh_trafo_complex_AVX512_1hv_single (float _Complex* q, float _Complex* hh, int* pnb, int* pnq, int* pldq
		  )
{
		...
		)
{
    ...
    x3 = _mm512_load_ps(&q_dbl[2*16]);
    x4 = _mm512_load_ps(&q_dbl[3*16]);
    x5 = _mm512_load_ps(&q_dbl[4*16]);
    x6 = _mm512_load_ps(&q_dbl[5*16]);
    ...
    for (i = 1; i < nb; i++)
    {
       ...
       h1_real = _mm512_set1_ps(hh_dbl[(i-1+1)*2]);
       h1_imag = _mm512_set1_ps(hh_dbl[((i-1+1)*2)+1]);


        q1 = _mm512_load_ps(&q_dbl[(2*i*ldq)+0]);
        q2 = _mm512_load_ps(&q_dbl[(2*i*ldq)+16]);
        q3 = _mm512_load_ps(&q_dbl[(2*i*ldq)+2*16]);
        q4 = _mm512_load_ps(&q_dbl[(2*i*ldq)+3*16]);
        q5 = _mm512_load_ps(&q_dbl[(2*i*ldq)+4*16]);
        q6 = _mm512_load_ps(&q_dbl[(2*i*ldq)+5*16]);

        tmp1 = _mm512_mul_ps(  h1_imag, q1);
        x1 = _mm512_add_ps(  x1, _mm512_fmsubadd_round_ps((h1_real), (q1), (_mm512_shuffle_ps(tmp1, tmp1, 0xb1)), 0x04));

        tmp2 = _mm512_mul_ps(  h1_imag, q2);
        x2 = _mm512_add_ps(  x2, _mm512_fmsubadd_round_ps((h1_real), (q2), (_mm512_shuffle_ps(tmp2, tmp2, 0xb1)), 0x04));

        tmp3 = _mm512_mul_ps(  h1_imag, q3);
        x3 = _mm512_add_ps(  x3, _mm512_fmsubadd_round_ps((h1_real), (q3), (_mm512_shuffle_ps(tmp3, tmp3, 0xb1)), 0x04));

        tmp4 = _mm512_mul_ps(  h1_imag, q4);
        x4 = _mm512_add_ps(  x4, _mm512_fmsubadd_round_ps((h1_real), (q4), (_mm512_shuffle_ps(tmp4, tmp4, 0xb1)), 0x04));

        tmp5 = _mm512_mul_ps(  h1_imag, q5);
        x5 = _mm512_add_ps(  x5, _mm512_fmsubadd_round_ps((h1_real), (q5), (_mm512_shuffle_ps(tmp5, tmp5, 0xb1)), 0x04));

        tmp6 = _mm512_mul_ps(  h1_imag, q6);
        x6 = _mm512_add_ps(  x6, _mm512_fmsubadd_round_ps((h1_real), (q6), (_mm512_shuffle_ps(tmp6, tmp6, 0xb1)), 0x04));
    ...
    x1 = _mm512_fmaddsub_round_ps((h1_real), (x1), (_mm512_shuffle_ps(tmp1, tmp1, 0xb1)), 0x04);

    tmp2 = _mm512_mul_ps(  h1_imag, x2);
    x2 = _mm512_fmaddsub_round_ps((h1_real), (x2), (_mm512_shuffle_ps(tmp2, tmp2, 0xb1)), 0x04);

    tmp3 = _mm512_mul_ps(  h1_imag, x3);
    x3 = _mm512_fmaddsub_round_ps((h1_real), (x3), (_mm512_shuffle_ps(tmp3, tmp3, 0xb1)), 0x04);

    tmp4 = _mm512_mul_ps(  h1_imag, x4);
    x4 = _mm512_fmaddsub_round_ps((h1_real), (x4), (_mm512_shuffle_ps(tmp4, tmp4, 0xb1)), 0x04);

    tmp5 = _mm512_mul_ps(  h1_imag, x5);
    x5 = _mm512_fmaddsub_round_ps((h1_real), (x5), (_mm512_shuffle_ps(tmp5, tmp5, 0xb1)), 0x04);

    tmp6 = _mm512_mul_ps(  h1_imag, x6);
    x6 = _mm512_fmaddsub_round_ps((h1_real), (x6), (_mm512_shuffle_ps(tmp6, tmp6, 0xb1)), 0x04);


    q1 = _mm512_load_ps(&q_dbl[0]);
    q2 = _mm512_load_ps(&q_dbl[16]);
    q3 = _mm512_load_ps(&q_dbl[2*16]);
    q4 = _mm512_load_ps(&q_dbl[3*16]);
    q5 = _mm512_load_ps(&q_dbl[4*16]);
    q6 = _mm512_load_ps(&q_dbl[5*16]);
    ...
    _mm512_store_ps(&q_dbl[2*16], q3);
    _mm512_store_ps(&q_dbl[3*16], q4);
    _mm512_store_ps(&q_dbl[4*16], q5);
    _mm512_store_ps(&q_dbl[5*16], q6);
    ...
    for (i = 1; i < nb; i++)
    {
        ...
        tmp1 = _mm512_mul_ps(  h1_imag, x1);
        q1 = _mm512_add_ps(  q1, _mm512_fmaddsub_round_ps((h1_real), (x1), (_mm512_shuffle_ps(tmp1, tmp1, 0xb1)), 0x04));

        tmp2 = _mm512_mul_ps(  h1_imag, x2);
        q2 = _mm512_add_ps(  q2, _mm512_fmaddsub_round_ps((h1_real), (x2), (_mm512_shuffle_ps(tmp2, tmp2, 0xb1)), 0x04));

        tmp3 = _mm512_mul_ps(  h1_imag, x3);
        q3 = _mm512_add_ps(  q3, _mm512_fmaddsub_round_ps((h1_real), (x3), (_mm512_shuffle_ps(tmp3, tmp3, 0xb1)), 0x04));

         tmp4 = _mm512_mul_ps(  h1_imag, x4);
         q4 = _mm512_add_ps(  q4, _mm512_fmaddsub_round_ps((h1_real), (x4), (_mm512_shuffle_ps(tmp4, tmp4, 0xb1)), 0x04));

         tmp5 = _mm512_mul_ps(  h1_imag, x5);
         q5 = _mm512_add_ps(  q5, _mm512_fmaddsub_round_ps((h1_real), (x5), (_mm512_shuffle_ps(tmp5, tmp5, 0xb1)), 0x04));

         tmp6 = _mm512_mul_ps(  h1_imag, x6);
         q6 = _mm512_add_ps(  q6, _mm512_fmaddsub_round_ps((h1_real), (x6), (_mm512_shuffle_ps(tmp6, tmp6, 0xb1)), 0x04));



         _mm512_store_ps(&q_dbl[(2*i*ldq)+0], q1);
         _mm512_store_ps(&q_dbl[(2*i*ldq)+16], q2);
         _mm512_store_ps(&q_dbl[(2*i*ldq)+2*16], q3);
         _mm512_store_ps(&q_dbl[(2*i*ldq)+3*16], q4);
         _mm512_store_ps(&q_dbl[(2*i*ldq)+4*16], q5);
         _mm512_store_ps(&q_dbl[(2*i*ldq)+5*16], q6);
    }
		...
		)
{
    ...
    __m512 x1, x2, x3, x4, x5;
    __m512 q1, q2, q3, q4, q5;
    __m512 h1_real, h1_imag;
    __m512 tmp1, tmp2, tmp3, tmp4, tmp5;
    int i=0;
