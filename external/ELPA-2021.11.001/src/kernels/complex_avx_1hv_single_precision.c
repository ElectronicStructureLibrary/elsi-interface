...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_24_AVX_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq 
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_20_AVX_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );
...
static __attribute__((always_inline)) void hh_trafo_complex_kernel_16_AVX_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_12_AVX_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_8_AVX_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );




static __attribute__((always_inline)) void hh_trafo_complex_kernel_4_AVX_1hv_single(float _Complex* q, float _Complex* hh, int nb, int ldq
		                       );
...
void single_hh_trafo_complex_AVX_1hv_single (float _Complex* q, float _Complex* hh, int* pnb, int* pnq, int* pldq
		  )
{
		...
		)
{
    ...
    for (i = 1; i < nb; i++)
    {
       ...
       h1_imag = _mm256_broadcast_ss(&hh_dbl[((i-1+1)*2)+1]);
        ...
        x4 = _mm256_add_ps(  x4, _mm256_addsub_ps(_mm256_mul_ps( h1_real, q4), _mm256_shuffle_ps(tmp4, tmp4, 0xb1)));

        tmp5 = _mm256_mul_ps(  h1_imag, q5);
        x5 = _mm256_add_ps(  x5, _mm256_addsub_ps(_mm256_mul_ps( h1_real, q5), _mm256_shuffle_ps(tmp5, tmp5, 0xb1)));

        tmp6 = _mm256_mul_ps(  h1_imag, q6);
        x6 = _mm256_add_ps(  x6, _mm256_addsub_ps(_mm256_mul_ps( h1_real, q6), _mm256_shuffle_ps(tmp6, tmp6, 0xb1)));
    ...
    x4 = _mm256_addsub_ps(_mm256_mul_ps( h1_real, x4), _mm256_shuffle_ps(tmp4, tmp4, 0xb1));

    tmp5 = _mm256_mul_ps(  h1_imag, x5);
    x5 = _mm256_addsub_ps(_mm256_mul_ps( h1_real, x5), _mm256_shuffle_ps(tmp5, tmp5, 0xb1));

    tmp6 = _mm256_mul_ps(  h1_imag, x6);
    x6 = _mm256_addsub_ps(_mm256_mul_ps( h1_real, x6), _mm256_shuffle_ps(tmp6, tmp6, 0xb1));
	...
	h1_real = _mm256_broadcast_ss(&hh_dbl[(i-1+1)*2]);
        ...
        q3 = _mm256_add_ps(  q3, _mm256_addsub_ps(_mm256_mul_ps( h1_real, x3), _mm256_shuffle_ps(tmp3, tmp3, 0xb1)));
         ...
         tmp4 = _mm256_mul_ps(  h1_imag, x4);
         q4 = _mm256_add_ps(  q4, _mm256_addsub_ps(_mm256_mul_ps( h1_real, x4), _mm256_shuffle_ps(tmp4, tmp4, 0xb1)));

         tmp5 = _mm256_mul_ps(  h1_imag, x5);
         q5 = _mm256_add_ps(  q5, _mm256_addsub_ps(_mm256_mul_ps( h1_real, x5), _mm256_shuffle_ps(tmp5, tmp5, 0xb1)));

         tmp6 = _mm256_mul_ps(  h1_imag, x6);
         q6 = _mm256_add_ps(  q6, _mm256_addsub_ps(_mm256_mul_ps( h1_real, x6), _mm256_shuffle_ps(tmp6, tmp6, 0xb1)));
