...
__attribute__((always_inline)) static void hh_trafo_kernel_24_AVX2_2hv_double (double* q, double* hh, int nb, int ldq, int ldh,
               double s)
  {
    ...
    __m256d y1 = _mm256_fmadd_pd(x1,h1,q1);
    __m256d q2 = _mm256_load_pd(&q[4]);
    __m256d y2 = _mm256_fmadd_pd(x2,h1,q2);
    __m256d q3 = _mm256_load_pd(&q[2*4]);
    __m256d y3 = _mm256_fmadd_pd(x3,h1,q3);
    __m256d q4 = _mm256_load_pd(&q[3*4]);
    __m256d y4 = _mm256_fmadd_pd(x4,h1,q4);
    __m256d q5 = _mm256_load_pd(&q[4*4]);
    __m256d y5 = _mm256_fmadd_pd(x5,h1,q5);
    __m256d q6 = _mm256_load_pd(&q[5*4]);
    __m256d y6 = _mm256_fmadd_pd(x6,h1,q6);
    ...
    for(i = 2; i < nb; i++)
      {
        ...
        x1 = _mm256_fmadd_pd(q1,h1,x1);
        y1 = _mm256_fmadd_pd(q1,h2,y1);
        x2 = _mm256_fmadd_pd(q2,h1,x2);
        y2 = _mm256_fmadd_pd(q2,h2,y2);
        x3 = _mm256_fmadd_pd(q3,h1,x3);
        y3 = _mm256_fmadd_pd(q3,h2,y3);
        x4 = _mm256_fmadd_pd(q4,h1,x4);
        y4 = _mm256_fmadd_pd(q4,h2,y4);
        x5 = _mm256_fmadd_pd(q5,h1,x5);
        y5 = _mm256_fmadd_pd(q5,h2,y5);
        x6 = _mm256_fmadd_pd(q6,h1,x6);
        y6 = _mm256_fmadd_pd(q6,h2,y6);
   ...
   y1 = _mm256_fmadd_pd(y1,h1,_mm256_mul_pd( x1,h2));
   y2 = _mm256_fmadd_pd(y2,h1,_mm256_mul_pd( x2,h2));
   y3 = _mm256_fmadd_pd(y3,h1,_mm256_mul_pd( x3,h2));
   y4 = _mm256_fmadd_pd(y4,h1,_mm256_mul_pd( x4,h2));
   y5 = _mm256_fmadd_pd(y5,h1,_mm256_mul_pd( x5,h2));
   y6 = _mm256_fmadd_pd(y6,h1,_mm256_mul_pd( x6,h2));
   ...
   q1 = _mm256_add_pd(  q1, _mm256_fmadd_pd(y1,h2,x1));
   q2 = _mm256_add_pd(  q2, _mm256_fmadd_pd(y2,h2,x2));
   q3 = _mm256_add_pd(  q3, _mm256_fmadd_pd(y3,h2,x3));
   q4 = _mm256_add_pd(  q4, _mm256_fmadd_pd(y4,h2,x4));
   q5 = _mm256_add_pd(  q5, _mm256_fmadd_pd(y5,h2,x5));
   q6 = _mm256_add_pd(  q6, _mm256_fmadd_pd(y6,h2,x6));
   ...
   for (i = 2; i < nb; i++)
   {
    ...
    h2 = _mm256_broadcast_sd(&hh[ldh+i-(2-2)]);
     ...
     q1 = _mm256_fmadd_pd(x1,h1,q1);
     q1 = _mm256_fmadd_pd(y1,h2,q1);
     q2 = _mm256_fmadd_pd(x2,h1,q2);
     q2 = _mm256_fmadd_pd(y2,h2,q2);
     q3 = _mm256_fmadd_pd(x3,h1,q3);
     q3 = _mm256_fmadd_pd(y3,h2,q3);
     q4 = _mm256_fmadd_pd(x4,h1,q4);
     q4 = _mm256_fmadd_pd(y4,h2,q4);
     q5 = _mm256_fmadd_pd(x5,h1,q5);
     q5 = _mm256_fmadd_pd(y5,h2,q5);
     q6 = _mm256_fmadd_pd(x6,h1,q6);
     q6 = _mm256_fmadd_pd(y6,h2,q6);
