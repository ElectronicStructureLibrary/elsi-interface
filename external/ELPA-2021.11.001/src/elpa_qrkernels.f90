...
(m,n,k,a,lda,v,ldv,t,ldt,z,ldz)
    ...
    ! input variables (local)
    integer(kind=ik) :: lda,ldv,ldt,ldz
    real(kind=rk4)    :: a(lda,*),v(ldv,*),t(ldt,*),z(ldz,*)
    ...
    ! local variables
    real(kind=rk4)    :: t11
    real(kind=rk4)    :: t12,t22,sum1,sum2
    real(kind=rk4)    :: t13,t23,t33,sum3
    real(kind=rk4)    :: sum4,t44
    real(kind=rk4)    :: y1,y2,y3,y4
    real(kind=rk4)    :: a1
    integer(kind=ik) :: icol,irow,v1col,v2col,v3col
...
(oldk,k,t,ldt,yty,ldy)
    ...
    integer(kind=ik) :: irow
    real(kind=rk4)    :: t11
    real(kind=rk4)    :: yty1,yty2,yty3,yty4,yty5,yty6,yty7,yty8
    real(kind=rk4)    :: reg01,reg02,reg03,reg04,reg05,reg06,reg07,reg08
    real(kind=rk4)    :: final01,final02,final03,final04,final05,final06,final07,final08
