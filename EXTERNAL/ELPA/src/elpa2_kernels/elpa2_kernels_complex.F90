...
module complex_generic_kernel
...
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_8_2hv_double")
#endif
  ...
  subroutine hh_trafo_complex_kernel_12_2hv_double(q, hh, nb, ldq, ldh, s)
    ...
    integer(kind=ik)                :: i
#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: hh_trafo_complex_kernel_12_2hv_double")
#endif
    x1 = q(1,2)
    x2 = q(2,2)
    x3 = q(3,2)
...
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_12_2hv_double")
#endif
...
! single precision implementation, at the moment duplicated !!
  ...
  subroutine single_hh_trafo_complex_generic_single(q, hh, nb, nq, ldq)
    ...
    integer(kind=ik)                :: i
#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: single_hh_trafo_complex_generic_single")
#endif
...
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: single_hh_trafo_complex_generic_single")
#endif
  ...
  subroutine double_hh_trafo_complex_generic_single(q, hh, nb, nq, ldq, ldh)
    ...
    ! Safety only:
#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: double_hh_trafo_complex_generic_single")
#endif
    ...
    !do i=1,nq-8,12
#ifdef DESPERATELY_WANT_ASSUMED_SIZE
    !   call hh_trafo_complex_kernel_12_2hv_single(q(i,1),hh, nb, ldq, ldh, s)
#else
    !   call hh_trafo_complex_kernel_12_2hv_single(q(i:ldq,1:nb+1),hh(1:ldh,1:2), nb, ldq, ldh, s)
#endif
    !enddo
    ...
    !if(nq-i+1 > 4) then
#ifdef DESPERATELY_WANT_ASSUMED_SIZE
    !   call hh_trafo_complex_kernel_8_2hv_single(q(i,1),hh, nb, ldq, ldh, s)
#else
    !   call hh_trafo_complex_kernel_8_2hv_single(q(i:ldq,1:nb+1),hh(1:ldh,1:2), nb, ldq, ldh, s)
#endif
    !else if(nq-i+1 > 0) then
#ifdef DESPERATELY_WANT_ASSUMED_SIZE
    !   call hh_trafo_complex_kernel_4_2hv_single(q(i:ldq,1:nb+1),hh(1:ldh,1:2), nb, ldq, ldh, s)
    ...
    !endif
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: double_hh_trafo_complex_generic_single")
#endif
  ...
  subroutine hh_trafo_complex_kernel_12_single(q, hh, nb, ldq)
    ...
    complex(kind=ck4), intent(in)    :: hh(*)
#else
    complex(kind=ck4), intent(inout) :: q(:,:)
    complex(kind=ck4), intent(in)    :: hh(1:nb)
#endif
    complex(kind=ck4)                :: x1, x2, x3, x4, x5, x6, x7, x8, x9, xa, xb, xc
    complex(kind=ck4)                :: h1, tau1
    integer(kind=ik)                :: i

#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: hh_trafo_complex_kernel_12_single")
#endif
...
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_12_single")
#endif
  ...
  subroutine hh_trafo_complex_kernel_8_single(q, hh, nb, ldq)
    ...
    complex(kind=ck4), intent(in)    :: hh(1:nb)
#endif
    complex(kind=ck4)                :: x1, x2, x3, x4, x5, x6, x7, x8
    complex(kind=ck4)                :: h1, tau1
    integer(kind=ik)                :: i

#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: hh_trafo_complex_kernel_8_single")
#endif
...
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_8_single")
#endif
  ...
  subroutine hh_trafo_complex_kernel_4_single(q, hh, nb, ldq)
    ...
    complex(kind=ck4), intent(in)    :: hh(1:nb)
#endif
    complex(kind=ck4)                :: x1, x2, x3, x4
    complex(kind=ck4)                :: h1, tau1
    integer(kind=ik)                :: i

#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: hh_trafo_complex_kernel_4_single")
#endif
    x1 = q(1,1)
    x2 = q(2,1)
    x3 = q(3,1)
    ...
    enddo
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_4_single")
#endif
  ...
  subroutine hh_trafo_complex_kernel_4_2hv_single(q, hh, nb, ldq, ldh, s)
    ...
    complex(kind=ck4), intent(in)    :: hh(1:ldh,1:2)
#endif
    complex(kind=ck4), intent(in)    :: s

    complex(kind=ck4)                :: x1, x2, x3, x4, y1, y2, y3, y4
    complex(kind=ck4)                :: h1, h2, tau1, tau2
    integer(kind=ik)                :: i
#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: hh_trafo_complex_kernel_4_2hv_single")
#endif
    x1 = q(1,2)
    x2 = q(2,2)
    x3 = q(3,2)
    ...
    q(4,nb+1) = q(4,nb+1) + x4*hh(nb,1)
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_4_2hv_single")
#endif
  ...
  subroutine hh_trafo_complex_kernel_8_2hv_single(q, hh, nb, ldq, ldh, s)
    ...
    complex(kind=ck4)                :: x1, x2, x3, x4, x5, x6 ,x7, x8, y1, y2, y3, y4, y5, y6, y7, y8
    complex(kind=ck4)                :: h1, h2, tau1, tau2
    integer(kind=ik)                :: i

#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: hh_trafo_complex_kernel_8_2hv_single")
#endif
    ...
    q(8,nb+1) = q(8,nb+1) + x8*hh(nb,1)
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_8_2hv_single")
#endif
  ...
  subroutine hh_trafo_complex_kernel_12_2hv_single(q, hh, nb, ldq, ldh, s)
    ...
    complex(kind=ck4)                :: x1, x2, x3, x4, x5, x6 ,x7, x8, x9, x10, x11, x12, y1, y2, y3, y4, y5, y6, &
                                       y7, y8, y9, y10, y11, y12
    complex(kind=ck4)                :: h1, h2, tau1, tau2
    integer(kind=ik)                :: i
#ifdef HAVE_DETAILED_TIMINGS
      call timer%start("kernel generic: hh_trafo_complex_kernel_12_2hv_single")
#endif
    x1 = q(1,2)
    x2 = q(2,2)
    x3 = q(3,2)
    ...
    q(12,nb+1) = q(12,nb+1) + x12*hh(nb,1)
#ifdef HAVE_DETAILED_TIMINGS
      call timer%stop("kernel generic: hh_trafo_complex_kernel_12_2hv_single")
#endif
